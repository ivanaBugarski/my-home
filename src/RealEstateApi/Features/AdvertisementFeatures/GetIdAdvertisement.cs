...
{
    public class GetIdAdvertisement
    {
        public record Request(int idAdvertisement) : IRequest<Advertisement>;
        ...
        public class Handler : IRequestHandler<Request, Advertisement>
        {
            ...
            {
                var chosenAdvertisements = await advertisementService.GetIdAdvertisementAsync(request.idAdvertisement);
